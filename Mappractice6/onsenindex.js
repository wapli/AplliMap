...
var area_copy=function(){
  var cop=document.getElementsByClassName("area_copy");

  for(var x=0;x<cop.length;x++){
    console.log(x+"aaa");
    var anon=cop[x];
    var masaya=anon.getBoundingClientRect();
    var posi=masaya.left;
    posi=posi+10;
    cop[x].style.left=posi+"px";
